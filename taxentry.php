...
<body>
<div class="flex px-5 md:px-20 md:h-screen justify-between gap-5 items-center bg-slate-300 ">

<section class='px-5 hidden md:flex py-10 mx-auto bg-slate-100 rounded-2xl w-52'>
