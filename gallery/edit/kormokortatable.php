...
<body class="md:px-10 mx-auto bg-gradient-to-r from-teal-50 to-sky-50">
    ...
    <a href="../ghome.php" class="text-center mb-3 font-semibold flex gap-3 mt-10 items-center sticky top-0 left-0 w-full ">
        ...
        Back</a>
        <p class='text-center text-2xl font-semibold'>কর্মকর্তা বর্গ ও কর্মচারী</p>
<!--hero section-->
<div class="my-10">
...
<thead>
    ...
    <?php
                    ...
                    $query = "SELECT * FROM `kormokortaborgo`";
...
<div class="flex gap-3 justify-center items-center w-full">
        ...
        <a href='../edit/kormokortaedit.php?id=<?php echo $id; ?>' class='px-3 py-2 cursor-pointer rounded-xl text-white text-sm  bg-green-700 hover:bg-green-600  duration-300 transition flex items-center gap-1'>
