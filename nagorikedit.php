        ...
        <div class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
           ...
           <div class="space-y-1">
            ...
            <input class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400' type="text" name="birthno" placeholder='জন্ম নিবন্ধন নাম্বার ' value='<?php echo $birthno ?>'  required>
           </div>
           <div class="space-y-1">
