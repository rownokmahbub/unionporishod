    ...
    <div class="space-y-2">
      ...
      <form action="logout.php">
        ...
        <div class="flex items-center gap-1 mt-3">
          ...
          <a href='./gallery/porishodborgo.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 transition'>Gallery</a>
          <a href='home/gallery.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 transition'>Protisthan</a>
