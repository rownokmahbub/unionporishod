        ...
        <div class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
           ...
           <div class="space-y-1">
            ...
            <input class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400' type="text" name="gram" placeholder='গ্রাম' value='<?php echo $gram ?>'  required>
           </div>
           <div class="space-y-1">
            <span>ওয়ার্ড</span>
           
            <input class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400' type="text" name="ward" placeholder='ওয়ার্ড' value='<?php echo $word ?>'  required>
           </div>
           <div class="space-y-1">
            <span>বাসার ধরন</span>
            <input class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400' type="text" name="housetype" placeholder='জন্ম নিবন্ধন নাম্বার ' value='<?php echo $housetype ?>'  required>
           </div>
           <div class="space-y-1">
            <span>রুম নং</span>
            <input class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400' type="text" name="rnum" placeholder='রুম নং' value='<?php echo $roomno ?>'  required>
           </div>
           <div class="space-y-1">
            <span>কর</span>
            <input class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400' type="text" name="kor" placeholder='কর' value='<?php echo $totaltax ?>'  required>
           </div>
