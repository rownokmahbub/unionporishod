            ...
            <form action="waresreg.php" method="POST">
                <div class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
                        ...
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="birthno" placeholder='মৃত্যু নিবন্ধন নাম্বার ' required>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="voterid" placeholder='ভোটার আইডি' required>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="mnum" placeholder='আবেদনকারীর মোবাইল নাম্বার' required>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="aname" placeholder='আবেদনকারীর নাম' required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w1" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r1" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w2" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r2" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w3" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r3" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w4" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r4" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w5" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r5" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w6" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r6" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w7" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r7" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w8" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r8" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w9" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r9" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w10" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r10" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w11" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r11" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w12" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r12" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w13" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r13" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w14" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r14" placeholder='সম্পর্ক'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="w15" placeholder='নাম'>
                        <input
                            class='px-2 py-2 bg-white border border-gray-300 rounded-xl w-full focus:outline-blue-400'
                            type="text" name="r15" placeholder='সম্পর্ক'>
                    </div>
