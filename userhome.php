...
<body class="md:px-32 mx-auto bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50">
  <div class="flex flex-col gap-10 px-5 justify-center items-center md:h-screen">
    <div class="space-y-2 text-center">
      ...
      <p class='mb-10'>Here you can update your files easily</p>
    ...
    <form action="userlogout.php">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 items-center mt-2">
        ...
        <a href='taxentrytable.php' class='px-4 py-2.5 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>ট্যাক্স এডিট </a>
        ...
        <a href='tadeentrytable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>টেড এডিট</a>
        ...
        <a href='warestable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>ওয়ারেশ আবেদন</a>
        ...
        <a href='boyoskotable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>বয়স্ক ভাতা এডিট</a>
        ...
        <a href='bidhobatable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>বিধবা এডিট</a>
        ...
        <a href='protibondhitable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>প্রতিবন্ধী এডিট</a>
        ...
        <a href='masisutable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>মা ও শিশু ভাতা এডিট</a>
      </div>
      <br><br>
