  ...
  <div class="flex flex-col gap-10 px-5 justify-center items-center md:h-screen">
    ...
    <form action="userlogout.php">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 items-center mt-2">
        ...
        <a href='boyoskotable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>বয়স্ক ভাতা টেবিল</a>
        ...
        <a href='bidhobatable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>বিধবা টেবিল</a>
        ...
        <a href='protibondhitable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>প্রতিবন্ধী টেবিল</a>
        ...
        <a href='masisutable.php' class='px-4 py-2 cursor-pointer rounded-full text-white font-semibold text-base bg-sky-800 hover:bg-sky-600  duration-300 text-center transition'>মা ও শিশু ভাতা টেবিল</a>
      </div>
      <br><br>
