  ...
  <div class="flex flex-col gap-10 px-5 justify-center items-center md:h-screen">
    ...
    <form action="userlogout.php">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 items-center mt-2">
        ...
        <a href='taxentrytable.php' class='px-4 py-2.5 cursor-pointer rounded-full text-white font-semibold text-base bg-purple-800 hover:bg-purple-600  duration-300 text-center transition'>ট্যাক্স এডিট </a>
