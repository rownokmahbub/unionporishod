...
<body class="md:px-10 mx-auto bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 z-40">
  ...
  <a href="./userhome.php" class="text-center mb-3 font-semibold flex gap-3 mt-10 items-center sticky top-0 left-0 w-full ">
    ...
    Back</a>
  <p class='text-center text-2xl font-semibold'>মা ও শিশু ভাতা টেবিল</p>
  <!--hero section-->
  <div class="my-10">
          ...
          <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
            ...
            <td class=''>
              ...
              <div class="flex gap-3 justify-center items-center w-full">
                ...
                <a href='masisuedit.php?id=<?php echo $id; ?>' class='px-3 py-2 cursor-pointer rounded-xl text-white text-sm  bg-green-700 hover:bg-green-600  duration-300 transition flex items-center gap-1'>
                ...
                <a href='masisudelete.php?id=<?php echo $id; ?>' class='px-3 py-2 cursor-pointer rounded-xl text-white text-sm  bg-red-700 hover:bg-red-600  duration-300 transition flex items-center gap-1'>
