...
<a href="../phome.php" class="text-center bg-white font-semibold flex gap-3 items-center sticky top-0 left-0 w-full py-5 px-5">
    ...
    <table id="example" class="display rounded-md overflow-hidden" style="width:100%">
        ...
        <?php
                ...
                <a class="flex items-center text-teal-900 hover:font-medium" href="../delete/sdelete.php?id=<?php echo $id; ?>">
